            ...
            <form action="joinSave.php" name="join" method="post">
                <fieldset>
                    ...
                    <div>
                        ...
                        <input type="email" id="youEmail" name="youEmail" class="input_style1" placeholder="이메일을 입력해 주세요." required>
                    </div>
                    <div>
                        <label for="youName">이름</label>
                        <input type="text" id="youName" name="youName" class="input_style1" placeholder="이름을 입력해 주세요." required>
                    </div>
                    <div>
                        <label for="youPass">비밀번호</label>
                        <input type="password" id="youPass" name="youPass" class="input_style1" placeholder="비밀번호를 입력해 주세요." required>
                    </div>
                    <div>
