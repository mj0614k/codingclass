...
<?php
    // 두개의 테이블 join
    $sql = "SELECT b.boardID, b.boardTitle, m.youName, b.regTime, b.boardView FROM Board b JOIN Member m ON (b.memberID = m.memberID) ORDER BY boardID DESC LIMIT {$viewLimit}, {$viewNum}";
