                            ...
                            <div class="review__write">
                                <div class="writeBox">
                                    <div>
                                        ...
                                        <input type="text" name="FAQTitle" id="FAQTitle" class="notice__Title" placeholder="제목을 입력해 주세요." required>
                                    </div>
                                    <div style="margin-top: 20px;">
                                        <label class="blind" for="FAQSubTitle">부제목</label>
                                        <input type="text" name="FAQSubTitle" id="FAQSubTitle" class="notice__SubTitle" placeholder="부제목을 입력해 주세요." required>
                                    </div>
                                    <div>
