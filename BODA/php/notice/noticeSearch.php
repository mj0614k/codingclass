...
<?php
    ...
    $sql = "SELECT n.myNoticeID, n.NoticeTitle, n.NoticeSubTitle, n.NoticeImgFile, n.NoticeContents, m.myMemberID, n.NoticeregTime FROM myNotice n JOIN myMember m ON(n.myMemberID = m.myMemberID)";
